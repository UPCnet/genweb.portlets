...
#from genweb.portlets.portlets import rssvideoportletMessageFactory as _


class Irssvideoportlet(IPortletDataProvider):
    """A portlet
...
class Renderer(base.Renderer):
    ...
    render = ViewPageTemplateFile('rssvideoportlet.pt')
...
class AddForm(base.AddForm):
    ...
    """
    form_fields = form.Fields(Irssvideoportlet)
